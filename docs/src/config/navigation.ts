...
export const nodeNavigation: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Valkey Store', href: '/docs/stores/valkey' },
      { label: 'DragonflyDB Store', href: '/docs/stores/dragonfly' },
      { label: 'Postgres Store', href: '/docs/stores/postgres' },
      { label: 'MongoDB Store', href: '/docs/stores/mongodb' },
      { label: 'MySQL Store', href: '/docs/stores/mysql' },
